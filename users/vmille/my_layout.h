...
#define ______BASE_T_LEFT______ KC_ENT, MS_BTN1, LT(NAV, KC_DEL)
...
#define ______________NAV_R2_LEFT______________ RM_NEXT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
#define ______________NAV_R3_LEFT______________ RM_TOGG, XXXXXXX, KC_LALT, KC_LSFT, KC_RCTL, KC_LCTL
#define ______________NAV_R4_LEFT______________ RM_PREV, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
...
#define ______MOUSE_T_LEFT______ MS_BTN2, MS_BTN1, MS_BTN3
